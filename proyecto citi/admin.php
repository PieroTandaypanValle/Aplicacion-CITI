...
if (isset($_GET['eliminar'])) {
    ...
    $delete_query = "DELETE FROM administrador WHERE rut_persona = '$rut_persona'";
    if (pg_query($conn, $delete_query)) {
        echo "<script>alert('Administrador eliminado exitosamente.'); window.location.href='admin.php';</script>";
    } else {
...
$total_query = "SELECT COUNT(*) AS total FROM administrador";
...
$suma_salarios_query = "SELECT SUM(salario) AS total_ingresos FROM administrador";
