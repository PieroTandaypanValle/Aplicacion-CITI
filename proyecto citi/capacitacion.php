...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['generarReporte'])) {
    ...
    <xml xmlns:x='urn:schemas-microsoft-com:office:excel' xmlns:ss='urn:schemas-microsoft-com:office:spreadsheet'>
        <Workbook xmlns='urn:schemas-microsoft-com:office:spreadsheet'>
            ...
            <Worksheet ss:Name='Reporte Capacitaciones'>
                <Table>
                    <Row ss:StyleID='s1'>
                        <Cell ss:MergeAcross='14'><Data ss:Type='String'>Reporte de Capacitaciones y Costos de la Empresa CITI</Data></Cell>
                    </Row>
                    <Row ss:StyleID='s1'>
                        <Cell ss:MergeAcross='14'><Data ss:Type='String'>EMPRESA: CITI</Data></Cell>
                    </Row>
                    <Row ss:StyleID='s1'>
                        <Cell ss:MergeAcross='14'><Data ss:Type='String'>FECHA: " . date('d/m/Y') . "</Data></Cell>
                    </Row>
                    <Row ss:StyleID='s1'>
    ...
    if (pg_num_rows($result) > 0) {
        ...
        $excel_content .= "<Row ss:StyleID='s2'><Cell ss:MergeAcross='15'><Data ss:Type='String'>No hay capacitaciones en el rango de fechas seleccionado.</Data></Cell></Row>";
    }

    // Agregar el total de capacitaciones al Excel
    $excel_content .= "<Row ss:StyleID='s2'>";
    $excel_content .= "<Cell ss:MergeAcross='14'><Data ss:Type='String'>Total Capacitaciones:</Data></Cell>";
    ...
    $excel_content .= "<Row ss:StyleID='s2'>";
    $excel_content .= "<Cell ss:MergeAcross='14'><Data ss:Type='String'>Total del costo de capacitaciones:</Data></Cell>";
