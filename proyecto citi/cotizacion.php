    ...
    <script>
        ...
        searchInput.addEventListener('input', function() {
            ...
            rows.forEach(row => {
                ...
                const fechaCreacion = row.querySelector('td:nth-child(5)').textContent.toLowerCase();
                const total = row.querySelector('td:nth-child(8)').textContent.toLowerCase();
                const condicionesPago = row.querySelector('td:nth-child(9)').textContent.toLowerCase();
