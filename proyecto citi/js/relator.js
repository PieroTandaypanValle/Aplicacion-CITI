document.addEventListener('DOMContentLoaded', function () {
    ...
    // Función para agregar un relator
    document.getElementById('formAgregar').addEventListener('submit', function (event) {
        ...
        const areaEspecialidad = document.getElementById('area_especialidad').value;
        const experienciaLaboral = document.getElementById('experiencia_laboral').value;
        const salario = document.getElementById('salario').value;
        const metodologiaEnsenanza = document.getElementById('metodologia_ensenanza').value;
        ...
        newRow.innerHTML = `
            ...
            <td>${direccion}</td>
            <td>${areaEspecialidad}</td>
            <td>${experienciaLaboral}</td>
            <td>${salario}</td>
            <td>${metodologiaEnsenanza}</td>
            <td>
                <div class="btn-group">
    ...
    function addEventListenersToButtons() {
        document.querySelectorAll('.btnActualizar').forEach(function (button) {
            button.addEventListener('click', function () {
                ...
                document.getElementById('emailActualizar').value = row.cells[3].innerText;
                document.getElementById('telefonoActualizar').value = row.cells[4].innerText;
                document.getElementById('fecha_nacimientoActualizar').value = row.cells[5].innerText;
                document.getElementById('direccionActualizar').value = row.cells[6].innerText;
                document.getElementById('area_especialidadActualizar').value = row.cells[7].innerText;
                document.getElementById('experiencia_laboralActualizar').value = row.cells[8].innerText;
                document.getElementById('salarioActualizar').value = row.cells[9].innerText;
                document.getElementById('metodologia_ensenanzaActualizar').value = row.cells[10].innerText;
                ...
                document.getElementById('formActualizar').onsubmit = function (event) {
                    ...
                    row.cells[3].innerText = document.getElementById('emailActualizar').value;
                    row.cells[4].innerText = document.getElementById('telefonoActualizar').value;
                    row.cells[5].innerText = document.getElementById('fecha_nacimientoActualizar').value;
                    row.cells[6].innerText = document.getElementById('direccionActualizar').value;
                    row.cells[7].innerText = document.getElementById('area_especialidadActualizar').value;
                    row.cells[8].innerText = document.getElementById('experiencia_laboralActualizar').value;
                    row.cells[9].innerText = document.getElementById('salarioActualizar').value;
                    row.cells[10].innerText = document.getElementById('metodologia_ensenanzaActualizar').value;
    ...
    function generarReportes() {
        ...
        const myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Relator 1', 'Relator 2', 'Relator 3'],
                datasets: [{
                    label: '# of Sessions',
                    data: [12, 19, 3],
                    backgroundColor: [
