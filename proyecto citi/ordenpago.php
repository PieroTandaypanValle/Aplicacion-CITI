...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['crear'])) {
    $folio = $_POST['folio'];
    $nro_cotizacion = $_POST['nro_cotizacion']; // Agregar nro_cotizacion
    ...
    $insert_query = "INSERT INTO orden_pago (folio, nro_cotizacion, rut_cliente, rut_persona, fecha_pago, metodo_pago, monto, iva, detalles_transaccion)
                     VALUES ('$folio', '$nro_cotizacion', '$rut_cliente', '$rut_persona', '$fecha_pago', '$metodo_pago', '$monto', '$iva', '$detalles_transaccion')";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['actualizar'])) {
    ...
    $nro_cotizacion = $_POST['nro_cotizacionActualizar']; // Agregar nro_cotizacion
    ...
    $update_query = "UPDATE orden_pago SET 
                    nro_cotizacion='$nro_cotizacion', // Agregar nro_cotizacion
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['generarReporte'])) {
    ...
    $query = "SELECT 
              ...
              c.rut_cliente,
              c.nombre_empresa
            FROM orden_pago AS op  -- Add the alias here
    ...
    if (!$result) {
        echo "<script>alert('Error al generar el reporte: " . pg_last_error($conn) . "');</script>";
            ...
            <Worksheet ss:Name='Reporte Ordenes de Pago'>
                <Table>
                    ...
                    <Row ss:StyleID='s1'>
                        ...
                        <Cell><Data ss:Type='String'>Nro Cotizacion</Data></Cell> // Agregar Nro Cotizacion
    ...
    if (pg_num_rows($result) > 0) {
        while ($row = pg_fetch_assoc($result)) {
            ...
            $excel_content .= "<Cell><Data ss:Type='String'>" . $row['nro_cotizacion'] . "</Data></Cell>"; // Agregar Nro Cotizacion
...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formAgregar" method="post" action="ordenpago.php">
                            ...
                            <div class="form-group">
                                <label for="nro_cotizacion">Nro Cotizacion</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formActualizar" method="post" action="ordenpago.php">
                            ...
                            <div class="form-group">
                                <label for="nro_cotizacionActualizar">Nro Cotizacion</label>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <select id="searchBy" class="form-control">
                                ...
                                <option value="nro_cotizacion">Nro Cotizacion</option>
                        ...
                        <table id="tablaOrdenPago" class="table table-striped table-bordered table-condensed" style="width:100%">
                            ...
                            <tbody id="tableBody">
                                ...
                                if (pg_num_rows($result) > 0) {
                                    ...
                                    echo "<tr><td colspan='10'>No hay ordenes de pago</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function setActualizarDatos(orden) {
            ...
            document.getElementById('nro_cotizacionActualizar').value = orden.nro_cotizacion;
        ...
        searchInput.addEventListener('input', function() {
            ...
            rows.forEach(row => {
                ...
                const nro_cotizacion = row.querySelector('td:nth-child(2)').textContent.toLowerCase(); // Agregar Nro Cotizacion
                const metodo = row.querySelector('td:nth-child(6)').textContent.toLowerCase();
                const detalles = row.querySelector('td:nth-child(9)').textContent.toLowerCase();
                ...
                if (searchTerm === '') {
                    ...
                    row.style.display = '';
                } else if (selectedFilter === 'nro_cotizacion' && nro_cotizacion.includes(searchTerm)) { // Agregar Nro Cotizacion
                    row.style.display = '';
